...
class LogController extends Controller
{
    ...
    public function detailMemo($id)
    {
        ...
        $cek = false;
        $cek1 = false;
    	return view('log.memo.detail', compact('user', 'metadataNaskah', 'cek', 'cek1', 'cekNaskah', 'cekTembusan', 'naskah', 'naskah1', 'no', 'no1', 'no2', 'getNaskah', 'userJabatan', 'klasifikasi', 'berkas', 'nomor_berkas', 'dataBerkas', 'sifatNaskah', 'isiDisposisi'));
    }
