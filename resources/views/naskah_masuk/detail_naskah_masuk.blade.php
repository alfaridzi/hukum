                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($data->id_user == Auth::user()->id_user && $naskah->count() >= $no)
                            <form action="{{ url('naskah-masuk/detail/'.$data->id_naskah.'/delete/'.$data->id_group) }}" method="post">
                            @csrf
...
<div class="modal fade" id="modal-final" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-final" action="{{ url('/naskah-masuk/detail/'.$metadataNaskah->id_naskah.'/dokumen-final') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-3">
