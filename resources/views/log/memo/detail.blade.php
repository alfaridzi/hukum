            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><ol>@foreach($data->files as $dataFiles)
                        <li><a href="{{ url('/log/memo/detail/'.$data->id_naskah.'/download/'.$dataFiles->nama_file) }}">{{ $dataFiles->nama_file }}</a></li>
                    @endforeach</ol></td>
                    <td>
                        @if(!$data->disposisi->isEmpty())
                        ...
                        @if($data->id_user == Auth::user()->id_user && $naskah->count() >= $no)
                            <form action="{{ url('/log/memo/detail/'.$data->id_naskah.'/delete/'.$data->id_group) }}" method="post">
                            @csrf
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-teruskan" action="{{ url('/log/memo/detail/'.$metadataNaskah->id_naskah.'/teruskan') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
...
<div class="modal fade" id="modal-balas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-balas" action="{{ url('/log/memo/detail/'.$metadataNaskah->id_naskah.'/balas') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <label>Tujuan Surat</label>
...
<div class="modal fade" id="modal-disposisi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-disposisi" action="{{ url('/log/memo/detail/'.$metadataNaskah->id_naskah.'/disposisi') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-3">
...
<div class="modal fade" id="modal-final" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-final" action="{{ url('/log/memo/detail/'.$metadataNaskah->id_naskah.'/dokumen-final') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-3">
