...
@if($getNaskah->penerima->whereIn('sebagai', ['final'])->isEmpty())
    @if(!$cekNaskah->isEmpty())
        ...
        @if($getNaskah->id_user == Auth::user()->id_user)
            <a href="{{ url('/log/naskah-keluar/detail/'.$metadataNaskah->id_naskah.'/ubah-metadata') }}" class="btn btn-warning">Ubah Metadata</a>
        @else
            <a href="{{ url('/log/naskah-keluar/detail/'.$metadataNaskah->id_naskah.'/ubah-metadata') }}" class="btn btn-warning">Ubah Metadata</a>
        @endif
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-teruskan" action="{{ url('/log/naskah-keluar/detail/'.$metadataNaskah->id_naskah.'/teruskan') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
...
<div class="modal fade" id="modal-balas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-balas" action="{{ url('/log/naskah-keluar/detail/'.$metadataNaskah->id_naskah.'/balas') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <label>Tujuan Surat</label>
...
<div class="modal fade" id="modal-disposisi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-disposisi" action="{{ url('/log/naskah-keluar/detail/'.$metadataNaskah->id_naskah.'/disposisi') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-3">
...
<div class="modal fade" id="modal-final" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="form-final" action="{{ url('/log/naskah-keluar/detail/'.$metadataNaskah->id_naskah.'/dokumen-final') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-3">
