...
<form class="form-horizontal" action="{{ url('pengaturan/instansi/'.$instansi->id_instansi.'/update') }}" method="post">
    @csrf
    <div class="form-group">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <input type="text" name="kode_instansi" class="form-control" value="{{ $instansi->kode_instansi }}">
        </div>
    </div>
    <div class="form-group">
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
            <input type="text" name="nama_lain" class="form-control" value="{{ $instansi->nama_lain }}">
        </div>
    </div>
    <div class="form-group">
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
            <input type="text" name="tipe_instansi" class="form-control" value="{{ $instansi->tipe_instansi }}">
        </div>
    </div>
    <div class="form-group">
        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
            <div class="input-group date" data-provide="datepicker">
			    <input type="text" class="form-control" name="tanggal_keberadaan" value="{{ $instansi->getTanggalKeberadaan() }}">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
        	<label class="radio-inline">
            	<input type="radio" name="status" value="1" @if($instansi->status == '1') checked @endif> Aktif
            </label>
            <label class="radio-inline">
            	<input type="radio" name="status" value="0" @if($instansi->status == '0') checked @endif> Tidak Aktif
            </label>
        </div>
    </div>
    <div class="form-group">
